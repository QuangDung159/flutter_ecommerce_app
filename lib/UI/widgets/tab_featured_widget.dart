              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(AssetHelper.panelSwim),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    image: DecorationImage(
                      image: AssetImage(AssetHelper.panelBike),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    image: DecorationImage(
                      image: AssetImage(AssetHelper.panelRun),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    image: DecorationImage(
                      image: AssetImage(AssetHelper.panelTrain),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    image: DecorationImage(
                      image: AssetImage(AssetHelper.panelYoga),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    image: DecorationImage(
                      image: AssetImage(AssetHelper.panelEquipment),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
